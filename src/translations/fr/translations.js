export const translations = {
  ...
  contact: {
    ...
    description: 'Je suis toujours enthousiaste à l\'idée de relever de nouveaux défis et de collaborer avec des personnes formidables. Que vous ayez besoin d\'une application web complète ou que vous souhaitiez discuter d\'un projet créatif, n\'hésitez pas à me contacter.',
    getInTouch: 'Me contacter',
    emailLabel: 'Email',
    ...
    thankYou: 'Merci de m\'avoir contactée. Je vous répondrai dans les 24 heures.',
    error: 'Désolée, il y a eu une erreur lors de l\'envoi de votre message'
  },
